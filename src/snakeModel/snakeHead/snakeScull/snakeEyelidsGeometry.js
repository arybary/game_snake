...
function snakeEyelidsGeometry() {
  ...
  const eyelidsBufferAttribute = new THREE.BufferAttribute(eyelidsVertices, 3);
  const eyelidsGeometry = new THREE.BufferGeometry();
  eyelidsGeometry.setAttribute("position", eyelidsBufferAttribute);
  const eyelids = new THREE.Mesh(eyelidsGeometry, material2);
  eyelids.position.set(1.5, 0, 1.5);
